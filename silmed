...
case "$1" in
	...
	;;
    getbesthash|getbestheight|getdifficulty|getnewaddress|getmyaddresses|getbalance|nethashrate|mempoolcount|version)
	if [ ! "$PID" ]; then
	    echo "Server not running"
	    exit
	fi
